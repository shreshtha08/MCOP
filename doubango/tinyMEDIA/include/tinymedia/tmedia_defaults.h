...
TINYMEDIA_API int tmedia_defaults_set_poc_qoe(tmedia_poc_qoe_profile_t profile, tmedia_poc_qoe_profile_strength_t strength);
TINYMEDIA_API tmedia_poc_qoe_profile_t tmedia_defaults_get_poc_qoe_profile();
TINYMEDIA_API tmedia_poc_qoe_profile_strength_t tmedia_defaults_get_poc_qoe_profile_strength();
