...
TINYSIP_API int tsip_api_publish_send_publish_affiliation(const tsip_ssession_handle_t *ss, ...);
TINYSIP_API int tsip_api_publish_send_unpublish_affiliation(const tsip_ssession_handle_t *ss, ...);
