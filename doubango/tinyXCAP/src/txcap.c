...
stack = txcap_stack_create(test_stack_callback, "sip:bob@organization.com", "mysecret", "http://organization.com:8080/services",
	...
	TXCAP_STACK_SET_HEADER("X-3GPP-Intended-Identity", "sip:bob@organization.com"),
...
char* urlstring = txcap_selector_get_url(stack, "resource-lists",
		TXCAP_SELECTOR_NODE_SET_ATTRIBUTE("list", "name", "rcs"),
		TXCAP_SELECTOR_NODE_SET_ATTRIBUTE("entry", "uri", "sip:bob@organization.com"),
		TXCAP_SELECTOR_NODE_SET_NULL());
TSK_DEBUG_INFO("%s\n", urlstring);
TSK_FREE(urlstring);
* @endcode
...
char* urlstring = txcap_selector_get_url(stack, "resource-lists",
		TXCAP_SELECTOR_NODE_SET_ATTRIBUTE("list", "name", "rcs"),
		TXCAP_SELECTOR_NODE_SET_POS_ATTRIBUTE("entry", 23, "uri", "sip:bob@organization.com"),
		TXCAP_SELECTOR_NODE_SET_NULL());
TSK_DEBUG_INFO("%s\n", urlstring);
TSK_FREE(urlstring);
* @endcode
...
X-3GPP-Intended-Identity: sip:bob@organization.com
...
* The XDMC will send:
* @code
GET /services/resource-lists/users/sip:bob@organization.com/index HTTP/1.1
Host: doubango.org:8080
Connection: Keep-Alive
User-Agent: XDM-client/OMA1.1
X-3GPP-Intended-Identity: sip:bob@organization.com
...
* The XDMC will send:
* @code
PUT /services/resource-lists/users/sip:bob@organization.com/index/~~/resource-lists/list\%5B\@name=\%22newlist\%22\%5D HTTP/1.1
Host: organization.com:8080
Content-Length: 110
Connection: Keep-Alive
User-Agent: XDM-client/OMA1.1
X-3GPP-Intended-Identity: sip:bob@organization.com
...
* The XDMC will send:
* @code
GET /services/resource-lists/users/sip:bob@organization.com/index/~~/resource-lists/list\%5B\@name=\%22newlist\%22\%5D HTTP/1.1
Host: organization.com:8080
Connection: Keep-Alive
User-Agent: XDM-client/OMA1.1
X-3GPP-Intended-Identity: sip:bob@organization.com
...
** @endcode
*
* ===	The code below shows how to add a new entry (“sip:alice@organization.com”) to the previously added list
* @code
int ret = txcap_action_create_element(stack,
		// selector
		TXCAP_ACTION_SET_SELECTOR("resource-lists",
			TXCAP_SELECTOR_NODE_SET_ATTRIBUTE("list", "name", "newlist"),
			¡XCAP_SELECTOR_NODE_SET_ATTRIBUTE("entry", "uri", “sip:alice@organization.com”),
			TXCAP_SELECTOR_NODE_SET_NULL()),
		// payload
		TXCAP_ACTION_SET_PAYLOAD(PAYLOAD, strlen(PAYLOAD)),
		// ends parameters
